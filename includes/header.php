 ...
 */
$page_title = $page_title ?? 'HostRadar — Discover Hosting Providers Worldwide';
...
<header class="site-header" id="siteHeader">
    <div class="container site-header__inner">
        ...
        <nav class="main-nav" id="mainNav">
            <a href="/index.php" class="<?= $active_nav === 'home' ? 'is-active' : '' ?>">Home</a>
            <a href="/providers.php" class="<?= $active_nav === 'providers' ? 'is-active' : '' ?>">Providers</a>
            <a href="/deals.php" class="<?= $active_nav === 'deals' ? 'is-active' : '' ?>">Hosting Deals</a>
        </nav>
        ...
        <div class="site-header__actions">
            ...
            <a href="/providers.php" class="btn btn--primary btn--sm site-header__cta">Compare Now</a>
